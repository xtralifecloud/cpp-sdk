...
#define CDELEGATE_COMMON_CODE(className) 	RetType Invoke() const { \
...
public:
	...
	typedef CDelegate0 type;

	CDELEGATE_COMMON_CODE(CDelegate0)

	// Construction and comparison functions
	CDelegate0() { clear(); }
	CDelegate0(const CDelegate0 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CDelegate0 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CDelegate0 &x) const {
	...
	CDelegate0(Y *pthis, DesiredRetType (X::* function_to_bind)() ) {
	...
	template < class X, class Y >
	CDelegate0(const Y *pthis, DesiredRetType (X::* function_to_bind)() const) {
	...
	CDelegate0(DesiredRetType (*function_to_bind)() ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	void operator = (DesiredRetType (*function_to_bind)() ) {
		bind(function_to_bind);	}
	inline void bind(DesiredRetType (*function_to_bind)()) {
		m_Closure.bindstaticfunc(this, &CDelegate0::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef CDelegate1 type;

	CDELEGATE_COMMON_CODE(CDelegate1)

	// Construction and comparison functions
	CDelegate1() { clear(); }
	CDelegate1(const CDelegate1 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CDelegate1 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CDelegate1 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const CDelegate1 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const CDelegate1 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	CDelegate1(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	CDelegate1(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	CDelegate1(DesiredRetType (*function_to_bind)(Param1 p1) ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	void operator = (DesiredRetType (*function_to_bind)(Param1 p1) ) {
		bind(function_to_bind);	}
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1)) {
		m_Closure.bindstaticfunc(this, &CDelegate1::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef CDelegate2 type;

	CDELEGATE_COMMON_CODE(CDelegate2)

	// Construction and comparison functions
	CDelegate2() { clear(); }
	CDelegate2(const CDelegate2 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CDelegate2 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CDelegate2 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const CDelegate2 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const CDelegate2 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	CDelegate2(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	CDelegate2(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	CDelegate2(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2) ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2)) {
		m_Closure.bindstaticfunc(this, &CDelegate2::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef CDelegate3 type;

	CDELEGATE_COMMON_CODE(CDelegate3)

	// Construction and comparison functions
	CDelegate3() { clear(); }
	CDelegate3(const CDelegate3 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const CDelegate3 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const CDelegate3 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const CDelegate3 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const CDelegate3 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	CDelegate3(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	CDelegate3(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	CDelegate3(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3) ) {
		bind(function_to_bind);	}
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3)) {
		m_Closure.bindstaticfunc(this, &CDelegate3::InvokeStaticFunction, 
			function_to_bind); }
	// Invoke the delegate
...
// 
//				CDelegate<> class (Original author: Jody Hagins)
//	Allows boost::function style syntax like:
//			CDelegate< double (int, long) >
// instead of:
//			CDelegate2< int, long, double >
//
////////////////////////////////////////////////////////////////////////////////

#ifdef FASTDELEGATE_ALLOW_FUNCTION_TYPE_SYNTAX

// Declare CDelegate as a class template.  It will be specialized
...
template<typename R>
class CDelegate< R (  ) >
  // Inherit from CDelegate0 so that it can be treated just like a CDelegate0
  : public CDelegate0 < R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CDelegate0 < R > BaseType;

  // Allow users access to the specific type of this delegate.
  typedef CDelegate SelfType;
  ...
  template < class X, class Y >
  CDelegate(const Y *pthis,
      R (X::* function_to_bind)(  ) const)
    : BaseType(pthis, function_to_bind)
  {  }

  CDelegate(R (*function_to_bind)(  ))
...
class CDelegate< R ( Param1 ) >
  // Inherit from CDelegate1 so that it can be treated just like a CDelegate1
  : public CDelegate1 < Param1, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CDelegate1 < Param1, R > BaseType;
  ...
  CDelegate(R (*function_to_bind)( Param1 p1 ))
    : BaseType(function_to_bind)  { }
  void operator = (const BaseType &x)  {	  
		*static_cast<BaseType*>(this) = x; }
};
...
// instead of 
// CDelegate2 < Param1, Param2, R >
template<typename R, class Param1, class Param2>
class CDelegate< R ( Param1, Param2 ) >
  // Inherit from CDelegate2 so that it can be treated just like a CDelegate2
  : public CDelegate2 < Param1, Param2, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CDelegate2 < Param1, Param2, R > BaseType;
  ...
  CDelegate(R (*function_to_bind)( Param1 p1, Param2 p2 ))
    : BaseType(function_to_bind)  { }
  void operator = (const BaseType &x)  {	  
		*static_cast<BaseType*>(this) = x; }
};
...
// instead of 
// CDelegate3 < Param1, Param2, Param3, R >
template<typename R, class Param1, class Param2, class Param3>
class CDelegate< R ( Param1, Param2, Param3 ) >
  // Inherit from CDelegate3 so that it can be treated just like a CDelegate3
  : public CDelegate3 < Param1, Param2, Param3, R >
{
public:
  // Make using the base type a bit easier via typedef.
  typedef CDelegate3 < Param1, Param2, Param3, R > BaseType;
  ...
  CDelegate(R (*function_to_bind)( Param1 p1, Param2 p2, Param3 p3 ))
    : BaseType(function_to_bind)  { }
  void operator = (const BaseType &x)  {	  
		*static_cast<BaseType*>(this) = x; }
};
...
CDelegate<FASTDLGT_RETTYPE> *MakeDelegate(Y* x, RetType (X::*func)()) { 
	return new CDelegate<FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class RetType>
CDelegate<FASTDLGT_RETTYPE> *MakeDelegate(Y* x, RetType (X::*func)() const) { 
	return new CDelegate<FASTDLGT_RETTYPE>(x, func);
}

//N=1
template <class X, class Y, class Param1, class RetType>
CDelegate<FASTDLGT_RETTYPE(Param1)> *MakeDelegate(Y* x, RetType (X::*func)(Param1 p1)) { 
	return new CDelegate<FASTDLGT_RETTYPE(Param1)>(x, func);
}

template <class X, class Y, class Param1, class RetType>
CDelegate<FASTDLGT_RETTYPE(Param1)> *MakeDelegate(Y* x, RetType (X::*func)(Param1 p1) const) { 
	return new CDelegate<FASTDLGT_RETTYPE(Param1)>(x, func);
}

//N=2
template <class X, class Y, class Param1, class Param2, class RetType>
CDelegate<FASTDLGT_RETTYPE(Param1, Param2)> *MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2)) { 
	return new CDelegate<FASTDLGT_RETTYPE(Param1, Param2)>(x, func);
}

template <class X, class Y, class Param1, class Param2, class RetType>
CDelegate<FASTDLGT_RETTYPE(Param1, Param2)> *MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2) const) { 
	return new CDelegate<FASTDLGT_RETTYPE(Param1, Param2)>(x, func);
}

//N=3
template <class X, class Y, class Param1, class Param2, class Param3, class RetType>
CDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3)> *MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3)) { 
	return new CDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3)>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class RetType>
CDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3)> *MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3) const) { 
	return new CDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3)>(x, func);
}
