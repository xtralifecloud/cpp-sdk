	...
	public:
		...
		*/
		...
		/**
			...
			@param aCode is a string as generated by Cloudbuilder::CUserManager::GetGodfatherCode.
		...
		*/
        ...
        DEPRECATED void Link(CResultHandler *aHandler, const Helpers::CHJSON* aConfiguration);
        DEPRECATED void Link(const char *aNetwork, CResultHandler *aHandler);
        DEPRECATED void Convert(CResultHandler *aHandler, const Helpers::CHJSON *aConfiguration);
        DEPRECATED void SetProperties(CResultHandler *aHandler, const Helpers::CHJSON* aPropertiesList, const char *aDomain="private");
        DEPRECATED void GetProperties(CResultHandler *aHandler, const char *aDomain="private");
        DEPRECATED void SetProperty(CResultHandler *aHandler, const Helpers::CHJSON* aProperty, const char *aDomain="private");
        ...
        DEPRECATED void Publish(const char *aNetwork, const Helpers::CHJSON* aMessage, CResultHandler *aHandler);
        ...
        DEPRECATED void KeyValueWrite(const Helpers::CHJSON *aConfiguration, CResultHandler *aHandler);
        DEPRECATED void KeyValueDelete(const Helpers::CHJSON *aConfiguration, CResultHandler *aHandler);
        DEPRECATED void BinaryRead(const Helpers::CHJSON *aConfiguration, CResultHandler *aHandler);
        DEPRECATED void BinaryWrite(const Helpers::CHJSON *aConfiguration, const void *aPointer, size_t aSize, CResultHandler *aHandler);
        DEPRECATED void BinaryDelete(const Helpers::CHJSON *aConfiguration, CResultHandler *aHandler);
        DEPRECATED void Batch(CResultHandler *aHandler, const Helpers::CHJSON *aConfiguration, const Helpers::CHJSON *aParameters);
